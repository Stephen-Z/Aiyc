...
<div class="pageheader">
  <h2><i class="fa fa-bars"></i> 文章管理 <span>回复高危</span>
      <?php
      if(!empty($cnrs)){
                      ...
                      <td>
                          <div class="dropdown">
                              ...
                              <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dLabel">
                                  <li><button class="btn btn-white btn-block btn-margin" type="button" onclick="postInfo(<?php echo $rs_row['order_id']?>,-1)">非高危</button></li>
                                  <li><button class="btn btn-white btn-block btn-margin" type="button" onclick="postInfo(<?php echo $rs_row['order_id']?>,1)">高危</button></li>
...
<script>
    function postInfo(articleID,isdanger) {
        $.ajax({
            type: "POST",
            async: true,
            url: "<?php echo base_url($admin_path.'/article/reply/updatedanager');?>",
            dataType: 'json',
