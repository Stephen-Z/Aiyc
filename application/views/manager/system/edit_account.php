...
<div class="pageheader">
  <h2><i class="fa fa-bars"></i> 系统设置 <span>修改管理员</span></h2>
...
<section class="contentpanel">
 <div class="panel">
  <div class="panel-body">
    <form class="form-horizontal tasi-form form-bordered" name="adminform" id="adminform" method="post" action="<?php echo $this->config->base_url($admin_path);?>/system/update_account">
        ...
        <div class="form-group <?php if(array_key_exists('name',$error)): echo 'has-error'; endif; ?>">
            ...
            <div class="col-sm-4">
                <input class="form-control" type="text" readonly value="<?php echo @$rs['name']?>">
                <?php
        ...
        <div class="form-group <?php if(array_key_exists('phone',$error)): echo 'has-error'; endif; ?>">
            ...
            <div class="col-sm-4">
                <input class="form-control" type="text" name="phone" value="<?php echo @$rs['phone']?>">
                <?php
        ...
        <div class="form-group <?php if(array_key_exists('password',$error)): echo 'has-error'; endif; ?>">
            ...
            <div class="col-sm-4">
                <input class="form-control" type="password" name="password" placeholder="不修改密码请留空">
                <?php
