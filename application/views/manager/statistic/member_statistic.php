            ...
            <table class="table border-top table-hover" >
                ...
                <?php if(!empty($rs)):?>
                    <?php foreach($rs as $rs_row):?>
                        <tr>
                            <td><?php echo $rs_row['member_id']?></td>
                            <td><?php echo $rs_row['member_name'] ?></td>
                            <td><?php echo $rs_row['article_comment_done'].'/'.$rs_row['article_comment_total']?></td>
                            <td><?php echo $rs_row['article_positive_done'].'/'.$rs_row['article_positive_total']?></td>
                            <td><?php echo $rs_row['reply_comment_done'].'/'.$rs_row['reply_comment_total']?></td>
                            <td><?php echo $rs_row['reply_positive_done'].'/'.$rs_row['article_positive_total']?></td>
