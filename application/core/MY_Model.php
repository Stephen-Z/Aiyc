...
//    }
    ...
    /**
     * Updated a record based on the primary value and update seed.
     */
    public function updateWithSeed($primary_value, $data, $seed, $skip_validation = FALSE)
    {
        $data = $this->trigger('before_update', $data);
     ...
     * Delete many rows from the database table by multiple primary values
     */
    public function delete_many_by($key,$primary_values)
    {
        $primary_values = $this->trigger('before_delete', $primary_values);

        $this->_database->where_in($key, $primary_values);
    ...
    /**
     * A wrapper to $this->_database->set()
     */
    ...
    /**
     * A wrapper to $this->_database->affected_rows()
     */
