...
class Articlelike_model extends MY_Model
{
    ...
    public function left_join_like($userid){
        ...
        $this->db->join('article_like','article.id = article_like.article_id AND article_like.deleted=0 AND article_like.user_id ='.$userid ,'left');
        $query=$this->db->get();
